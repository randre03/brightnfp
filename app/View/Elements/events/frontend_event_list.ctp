<?php
  $this->Paginator->options(array('update'=>'npoDiv','indicator'=>'loaderIDast'));
?><div id="container_left"><div class="dashbrd-right">
                	...
                	<div class="white-box">
                        ...
                        <div class="grey-head-tleft">
                        	<div class="grey-head-tright"><span>Events of <?php echo $npoTitle; ?></span></div>
                        </div>
                        ...
                        <div class="white-box-mid" style="min-height:300px">
                        	...
                        	<div class="prperties-detailbox">
                                <ul class="church_listing_widget">
                                  ...
                                  <li class="<?php echo $class; ?>">
                                    <div class="church_pic"><?php echo $value['Attribute']['thumb_name'] !='' ? $this->Html->image(str_replace('{id}',$npoId,Configure::read('CHURCH_EVENT_URL')).$value['Attribute']['thumb_name'],array('alt'=>$value['Attribute']['title'],'title'=>$value['Attribute']['title'])) :  $this->Html->image('/img/no_image_small.png') ?></div>
                                    ...
                                    <div class="right_buttons">
                                      <div class="margin_lft"><?php echo $this->Html->link('View',array('controller'=>'events','action'=>'viewevent',$value['Attribute']['id'],$npoId),array('class'=>'button_link')); ?> &nbsp; <?php echo $paypal->button('Donate', array('type' => 'donate','class'=>'button_input','item_name'=>$value['Attribute']['title'],'custom'=>$npoId.'-'.$value['Attribute']['id'],'return' => 'http://'.$_SERVER['HTTP_HOST'].'/paypal_ipn/process')); ?></div>
                                  ...
                                  <li style="text-align:center"><strong>No Event available right now.</strong></li>
                                  <?php } ?>
                                </ul>
                  			  </div> 
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;View <?php 
                                                       // $options = array('1'=>'1','2'=>'2','3'=>'3');
                                                        ...
                                                        echo $ajax->observeField('pagecount',array('url'=>array('controller'=>'events','action'=>'npoevent',$npoId),'update'=>'npoDiv','indicator'=>'loaderIDast'));
                                                       ?> 
                          <?php } ?>
                          </div>                 			 
