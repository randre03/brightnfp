<?php 
  $this->Paginator->options(array('update'=>'sentList','indicator'=>'loaderIDast'));
...
<div id="container_left"><div class="dashbrd-right">
                	...
                	<div class="white-box">
                        ...
                        <div class="grey-head-tleft">
                        	<div class="grey-head-tright"><span>Sent</span></div>
                        </div>
                        ...
                        <div class="white-box-mid">
                            ...
                            <div  class="search_widget">
                                ...
                                <ul class="search_fields_widget">
                                  <li>Search: <?php echo $this->Form->input('searchElement',array('type'=>'text','div'=>false,'label'=>false));?></li><li> Type:<?php $searchOptions = array('subject'=>'Subject','created'=>'Sent On','message'=>'Message'); echo $this->Form->input('searchType',array('type'=>'select','options'=>$searchOptions,'selected'=>'title','div'=>false,'label'=>false)); ?></li>
                                  <li><?php 
                         ...
                         <?php echo $this->Form->create(null,array('action'=>'deleteallmessage','method'=>'post','id'=>'frmMsg','name'=>'frmMsg'));
                               echo $this->Form->hidden('Message.type',array('type'=>'hidden','value'=>'sent'));
                          ?> 
              ...
              ?>
                                    <tr class="<?php echo $class; ?>">                                    
                                      ...
                                      <td><?php echo $i; ?>.</td>
                                      <td><?php echo strlen($value['Message']['subject']) > 50 ? $this->Html->link(substr($value['Message']['subject'],0,50).'....','/message/read/'.$value['Message']['id'].'/sent') : $this->Html->link($value['Message']['subject'],'/message/read/'.$value['Message']['id'].'/sent'); ?></td>
                                      <td><?php echo $value['Message']['read']; ?></td>
                                      <td><?php echo date(Configure::read('npoDateFormat'),strtotime($value['Message']['created'])); ?></td>
                                      <td><?php echo $ajax->link($this->Html->image('/img/delete.png',array('width'=>'16','height'=>'16')),array('controller'=>'message','action'=>'deletemessage',$value['Message']['id'],'sent'),array('update' => 'sentList','indicator'=>'loaderIDast','escape'=>false),'Are you sure to delete this message?')?></td>
                                    </tr>
              <?php } ?>
              <tr><td colspan="5"><?php 
...
<?php echo $this->Form->end(); ?>
                ...
                <?php
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;View <?php 
                                                  ...
                                                  echo $ajax->observeField('pagecount',array('url'=>array('controller'=>'message','action'=>'sent'),'update'=>'sentList','indicator'=>'loaderIDast'));
                                                 ?> 
                    <?php } ?>
                    </div>
