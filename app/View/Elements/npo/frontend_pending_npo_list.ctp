<?php 
  $this->Paginator->options(array('update'=>'pendingNpo','indicator'=>'loaderIDast'));
?><div id="container_left"><div class="dashbrd-right">
                	...
                	<div class="white-box">
                        ...
                        <div class="white-box-mid" style="min-height:300px"><div class="search_widget">
                                ...
                                <ul class="church_listing_widget">
                                  ...
                                  <li class="<?php echo $class; ?>">
                                    ...
                                    <div class="right_buttons">
                                      <div class="margin_lft"><?php echo $this->Html->link('View',array('controller'=>'npo','action'=>'viewpendingnpo',$value['Npo']['id']),array('class'=>'button_link'));?> <?php echo $paypal->button('Donate', array('type' => 'donate','class'=>'button_input','item_name'=>$value['Npo']['title'],'custom'=>$value['Npo']['id'].'-'.'0','return' => 'http://'.$_SERVER['HTTP_HOST'].'/paypal_ipn/process')); ?></div>
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;View <?php 
                                                        ...
                                                        echo $ajax->observeField('pagecount',array('url'=>array('controller'=>'npo','action'=>'index'),'update'=>'pendingNpo','indicator'=>'loaderIDast'));
                                                       ?> 
                          <?php } ?>
                          </div>                 			 
