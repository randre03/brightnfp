                                ...
                                <ul class="church_listing_widget">
                                  ...
                                  <li class="<?php echo $class; ?>">
                                    ...
                                    <div class="right_buttons">
                                      <div class="margin_lft"><?php echo $this->Html->link('View',array('controller'=>'npo','action'=>'viewmynpo',$value['Npo']['id']),array('class'=>'button_link'));?> <?php echo $paypal->button('Donate', array('type' => 'donate','class'=>'button_input','item_name'=>$value['Npo']['title'],'custom'=>$value['Npo']['id'].'-'.'0','return' => 'http://'.$_SERVER['HTTP_HOST'].'/paypal_ipn/process')); ?></div>
