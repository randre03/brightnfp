<div align="center">
<?php echo $this->Form->create(null,array('id'=>'frmLogin','name'=>'frmLogin','action'=>'login')); ?>
<table align="center" cellpadding="0" cellspacing="0" border="0" class="outerBorder">
    ...
    <tr>
      <td align="right"><strong><?php echo __('PASSWORD'); ?>:</strong></td>
      <td><?php echo $this->Form->input('Admin.adminPassword',array('type'=>'password','class'=>'required','id'=>'adminPassword','div'=>false,'label'=>false)); ?></td>
    </tr> 
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><?php echo $this->Form->submit('submit',array('type'=>'submit','id'=>'submit','value'=>'Login'));?> &nbsp; 
